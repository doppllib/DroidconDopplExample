...
- (void)runWithAndroidContentContext:(AndroidContentContext *)context {
  RetrofitRestAdapter *restAdapter = [((RetrofitRestAdapter_Builder *) nil_chk(CoTouchlabDroidconandroidNetworkDataHelper_makeRequestAdapterBuilderWithAndroidContentContext_withDCPPlatformClient_withNSString_withRetrofitErrorHandler_(context, DCPAppManager_getPlatformClient(), DCTSponsorsTask_URL_AMAZON_S3, create_CoTouchlabDroidconandroidNetworkNetworkErrorHandler_init()))) build];
  NSString *fileName = DCTSponsorsTask_getFileNameWithInt_(self, type_);
  JreStrongAssign(&response_, [((id<CoTouchlabDroidconandroidNetworkSponsorsRequest>) nil_chk([((RetrofitRestAdapter *) nil_chk(restAdapter)) createWithIOSClass:CoTouchlabDroidconandroidNetworkSponsorsRequest_class_()])) getSponsorsWithNSString:fileName]);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "response_", "LCoTouchlabDroidconandroidNetworkSponsorsResult;", .constantValue.asLong = 0, 0x1, -1, -1, -1, -1 },
  };
  ...
  static const J2ObjcClassInfo _DCTSponsorsTask = { "SponsorsTask", "co.touchlab.droidconandroid.tasks", ptrTable, methods, fields, 7, 0x1, 5, 6, -1, -1, -1, -1, -1 };
