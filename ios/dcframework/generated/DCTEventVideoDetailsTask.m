...
@interface DCTEventVideoDetailsTask () {
 @public
  jlong eventId_;
  CoTouchlabDroidconandroidSharedNetworkDaoEventVideoDetails *eventVideoDetails_;
}

@end

J2OBJC_FIELD_SETTER(DCTEventVideoDetailsTask, eventVideoDetails_, CoTouchlabDroidconandroidSharedNetworkDaoEventVideoDetails *)
...
- (CoTouchlabDroidconandroidSharedNetworkDaoEventVideoDetails *)getEventVideoDetails {
...
- (void)runWithAndroidContentContext:(AndroidContentContext *)context {
  RetrofitRestAdapter *restAdapter = CoTouchlabDroidconandroidSharedNetworkDataHelper_makeRequestAdapterWithAndroidContentContext_withDCPPlatformClient_(context, DCPAppManager_getPlatformClient());
  id<CoTouchlabDroidconandroidSharedNetworkRefreshScheduleDataRequest> refreshScheduleDataRequest = [((RetrofitRestAdapter *) nil_chk(restAdapter)) createWithIOSClass:CoTouchlabDroidconandroidSharedNetworkRefreshScheduleDataRequest_class_()];
  JreStrongAssign(&eventVideoDetails_, [((id<CoTouchlabDroidconandroidSharedNetworkRefreshScheduleDataRequest>) nil_chk(refreshScheduleDataRequest)) getEventVideoDetailsWithJavaLangLong:JavaLangLong_valueOfWithLong_(eventId_)]);
}
...
- (jboolean)hasStream {
  return eventVideoDetails_ != nil && (CoTouchlabDroidconandroidSharedUtilsStringUtils_isNotEmptyWithNSString_([eventVideoDetails_ getStreamLink]) || CoTouchlabDroidconandroidSharedUtilsStringUtils_isNotEmptyWithNSString_([((CoTouchlabDroidconandroidSharedNetworkDaoEventVideoDetails *) nil_chk(eventVideoDetails_)) getStreamArchiveLink]));
}

- (jboolean)isNow {
  return eventVideoDetails_ != nil && CoTouchlabDroidconandroidSharedUtilsStringUtils_isNotEmptyWithNSString_([eventVideoDetails_ getStreamLink]);
}

- (NSString *)getMergedStreamLink {
  if (eventVideoDetails_ == nil) return nil;
  return CoTouchlabDroidconandroidSharedUtilsStringUtils_isNotEmptyWithNSString_([eventVideoDetails_ getStreamLink]) ? [((CoTouchlabDroidconandroidSharedNetworkDaoEventVideoDetails *) nil_chk(eventVideoDetails_)) getStreamLink] : [((CoTouchlabDroidconandroidSharedNetworkDaoEventVideoDetails *) nil_chk(eventVideoDetails_)) getStreamArchiveLink];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    ...
    { NULL, "LCoTouchlabDroidconandroidSharedNetworkDaoEventVideoDetails;", 0x1, -1, -1, -1, -1, -1, -1 },
  ...
  static const J2ObjcFieldInfo fields[] = {
    ...
    { "eventVideoDetails_", "LCoTouchlabDroidconandroidSharedNetworkDaoEventVideoDetails;", .constantValue.asLong = 0, 0x2, -1, -1, -1, -1 },
  };
  ...
  static const J2ObjcClassInfo _DCTEventVideoDetailsTask = { "EventVideoDetailsTask", "co.touchlab.droidconandroid.shared.tasks", ptrTable, methods, fields, 7, 0x1, 9, 2, -1, -1, -1, -1, -1 };
