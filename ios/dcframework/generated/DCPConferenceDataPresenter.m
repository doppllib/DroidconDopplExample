...
- (void)refreshFromServer {
  ...
  if ((JavaLangSystem_currentTimeMillis() - [((DCDAppPrefs *) nil_chk(prefs)) getRefreshTime] > DCPConferenceDataPresenter_SERVER_REFRESH_TIME)) {
    CoTouchlabDroidconandroidSharedTasksPersistedRefreshScheduleData_callMeWithAndroidContentContext_([self getContext]);
  }
}
...
- (void)onEventMainThreadWithCoTouchlabDroidconandroidSharedTasksPersistedRefreshScheduleData:(CoTouchlabDroidconandroidSharedTasksPersistedRefreshScheduleData *)task {
  [self refreshConferenceData];
}
...
- (NSString *)getSlackLink {
  return CoTouchlabDroidconandroidSharedUtilsSlackUtils_createSlackLinkWithDCDVenue_(nil);
}

- (NSString *)getSlackLinkHttp {
  return CoTouchlabDroidconandroidSharedUtilsSlackUtils_createSlackLinkHttpWithDCDVenue_(nil);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[5].selector = @selector(onEventMainThreadWithCoTouchlabDroidconandroidSharedTasksPersistedRefreshScheduleData:);
  ...
  static const void *ptrTable[] = { "LAndroidContentContext;LDCPConferenceDataHost;Z", "onEventMainThread", "LDCTSeedScheduleDataTask;", "LDCPLoadConferenceDataTask;", "LCoTouchlabDroidconandroidSharedTasksPersistedRefreshScheduleData;", "styleEventRow", "LDCPScheduleBlockHour;LJavaUtilList;LDCPConferenceDataPresenter_EventRow;Z", "hasConflict", "LDCDEvent;LJavaUtilList;", "LDCPConferenceDataPresenter_EventRow;" };
  static const J2ObjcClassInfo _DCPConferenceDataPresenter = { "ConferenceDataPresenter", "co.touchlab.droidconandroid.shared.presenter", ptrTable, methods, fields, 7, 0x1, 11, 3, -1, 9, -1, -1, -1 };
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _DCPConferenceDataPresenter_EventRow = { "EventRow", "co.touchlab.droidconandroid.shared.presenter", ptrTable, methods, NULL, 7, 0x609, 8, 0, 11, -1, -1, -1, -1 };
