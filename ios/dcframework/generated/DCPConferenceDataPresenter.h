...
@class CoTouchlabDroidconandroidSharedTasksPersistedRefreshScheduleData;
@class DCDEvent;
...
@compatibility_alias CoTouchlabDroidconandroidSharedPresenterConferenceDataPresenter DCPConferenceDataPresenter;
