...
- (void)callStartVideoWithNSString:(NSString *)link
  ...
  DCPEventDetailPresenter_recordAnalyticsWithNSString_(self, CoTouchlabDroidconandroidSharedUtilsAnalyticsEvents_STREAM_CLICKED);
...
- (void)onEventMainThreadWithDCTEventDetailLoadTask:(DCTEventDetailLoadTask *)task {
  ...
  DCPEventDetailPresenter_recordAnalyticsWithNSString_(self, CoTouchlabDroidconandroidSharedUtilsAnalyticsEvents_OPEN_EVENT);
...
- (void)onEventMainThreadWithDCTStartWatchVideoTask:(DCTStartWatchVideoTask *)task {
  ...
  if (((DCTStartWatchVideoTask *) nil_chk(task))->videoOk_) {
    DCPEventDetailPresenter_recordAnalyticsWithNSString_(self, CoTouchlabDroidconandroidSharedUtilsAnalyticsEvents_STREAM_SUCCESS);
...
- (void)toggleRsvp {
  ...
  if ([eventDetailLoadTask_->event_ isRsvped]) {
    ...
    DCPEventDetailPresenter_recordAnalyticsWithNSString_(self, CoTouchlabDroidconandroidSharedUtilsAnalyticsEvents_UNRSVP_EVENT);
  }
  else {
    ...
    DCPEventDetailPresenter_recordAnalyticsWithNSString_(self, CoTouchlabDroidconandroidSharedUtilsAnalyticsEvents_RSVP_EVENT);
  }
}
...
- (void)openSlack {
  NSString *slackLink = CoTouchlabDroidconandroidSharedUtilsSlackUtils_createSlackLinkWithDCDVenue_(((DCDEvent *) nil_chk(((DCTEventDetailLoadTask *) nil_chk(eventDetailLoadTask_))->event_))->venue_);
  NSString *slackLinkHttp = CoTouchlabDroidconandroidSharedUtilsSlackUtils_createSlackLinkHttpWithDCDVenue_(((DCDEvent *) nil_chk(((DCTEventDetailLoadTask *) nil_chk(eventDetailLoadTask_))->event_))->venue_);
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _DCPEventDetailPresenter = { "EventDetailPresenter", "co.touchlab.droidconandroid.shared.presenter", ptrTable, methods, fields, 7, 0x1, 18, 4, -1, -1, -1, -1, -1 };
...
void DCPEventDetailPresenter_recordAnalyticsWithNSString_(DCPEventDetailPresenter *self, NSString *analyticsKey) {
  NSString *eventName = self->eventDetailLoadTask_ != nil && [self->eventDetailLoadTask_ getEvent] != nil ? CoTouchlabDroidconandroidSharedUtilsStringUtils_trimToEmptyWithNSString_([((DCDEvent *) nil_chk([self->eventDetailLoadTask_ getEvent])) getName]) : @"";
  [((id<DCPPlatformClient>) nil_chk(DCPAppManager_getPlatformClient())) logEventWithNSString:analyticsKey withNSStringArray:[IOSObjectArray arrayWithObjects:(id[]){ CoTouchlabDroidconandroidSharedUtilsAnalyticsEvents_PARAM_ITEM_ID, JavaLangLong_toStringWithLong_(self->eventId_), CoTouchlabDroidconandroidSharedUtilsAnalyticsEvents_PARAM_ITEM_NAME, eventName } count:4 type:NSString_class_()]];
}
