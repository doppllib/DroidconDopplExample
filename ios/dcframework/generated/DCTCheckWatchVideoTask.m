...
- (RetrofitClientResponse *)callVideoUrlWithCoTouchlabDroidconandroidSharedNetworkWatchVideoRequest:(id<CoTouchlabDroidconandroidSharedNetworkWatchVideoRequest>)watchVideoRequest
  ...
  return [((id<CoTouchlabDroidconandroidSharedNetworkWatchVideoRequest>) nil_chk(watchVideoRequest)) checkWatchVideoWithJavaLangLong:JavaLangLong_valueOfWithLong_(conventionId) withNSString:email withNSString:uuid withNSString:JavaLangLong_toStringWithLong_(eventId_)];
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "J", "callVideoUrl", "LCoTouchlabDroidconandroidSharedNetworkWatchVideoRequest;LNSString;LNSString;J" };
  static const J2ObjcClassInfo _DCTCheckWatchVideoTask = { "CheckWatchVideoTask", "co.touchlab.droidconandroid.shared.tasks", ptrTable, methods, fields, 7, 0x1, 2, 1, -1, -1, -1, -1, -1 };
