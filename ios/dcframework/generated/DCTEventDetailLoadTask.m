...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "J", "run", "LAndroidContentContext;", "LNSException;", "()Ljava/util/List<Lco/touchlab/droidconandroid/shared/data/UserAccount;>;", "handleError", "LAndroidContentContext;LNSException;", "onComplete", "hasConflict", "LDCDEvent;LJavaUtilList;", "Ljava/util/List<Lco/touchlab/droidconandroid/shared/data/UserAccount;>;" };
  static const J2ObjcClassInfo _DCTEventDetailLoadTask = { "EventDetailLoadTask", "co.touchlab.droidconandroid.shared.tasks", ptrTable, methods, fields, 7, 0x1, 9, 4, -1, -1, -1, -1, -1 };
