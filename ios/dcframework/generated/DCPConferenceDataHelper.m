...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _DCPConferenceDataHelper = { "ConferenceDataHelper", "co.touchlab.droidconandroid.shared.presenter", ptrTable, methods, fields, 7, 0x1, 3, 2, -1, -1, -1, -1, -1 };
...
+ (void)initialize {
  if (self == [DCPConferenceDataHelper class]) {
    {
      JreStrongAssign(&DCPConferenceDataHelper_dateFormat, CoTouchlabDroidconandroidSharedUtilsTimeUtils_makeDateFormatWithNSString_(@"MM/dd/yyyy"));
      JreStrongAssign(&DCPConferenceDataHelper_timeFormat, CoTouchlabDroidconandroidSharedUtilsTimeUtils_makeDateFormatWithNSString_(@"h:mma"));
    }
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  #pragma clang diagnostic pop
  static const void *ptrTable[] = { "compare", "LDCDScheduleBlock;LDCDScheduleBlock;", "LDCPConferenceDataHelper;", "listDaysWithAndroidContentContext:withBoolean:", "Ljava/lang/Object;Ljava/util/Comparator<Lco/touchlab/droidconandroid/shared/data/ScheduleBlock;>;" };
  static const J2ObjcClassInfo _DCPConferenceDataHelper_1 = { "", "co.touchlab.droidconandroid.shared.presenter", ptrTable, methods, NULL, 7, 0x8018, 2, 0, 2, -1, 3, 4, -1 };
