...
- (void)setEventbriteEmailWithNSString:(NSString *)email {
  if (CoTouchlabDroidconandroidSharedUtilsStringUtils_isEmptyWithNSString_(email)) [((id<AndroidContentSharedPreferences_Editor>) nil_chk([((id<AndroidContentSharedPreferences_Editor>) nil_chk([((id<AndroidContentSharedPreferences>) nil_chk(prefs_)) edit])) removeWithNSString:DCDAppPrefs_EVENTBRITE_EMAIL])) apply];
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _DCDAppPrefs = { "AppPrefs", "co.touchlab.droidconandroid.shared.data", ptrTable, methods, fields, 7, 0x1, 23, 11, -1, -1, -1, -1, -1 };
  return &_DCDAppPrefs;
}
