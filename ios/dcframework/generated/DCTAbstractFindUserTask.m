...
- (void)handleDataWithAndroidContentContext:(AndroidContentContext *)context
  ...
  CoTouchlabDroidconandroidSharedNetworkDaoUserInfoResponse *response = [((id<DCTAbstractFindUserTask_LoadUserInfo>) nil_chk(loadUserInfo)) load__];
  if (response != nil) {
    DCDUserAccount *updatedUser = DCTAbstractFindUserTask_saveUserResponseWithAndroidContentContext_withDCDUserAccount_withCoTouchlabDroidconandroidSharedNetworkDaoUserInfoResponse_(context, user_, response);
    if (updatedUser == nil) {
    }
    else {
...
withCoTouchlabDroidconandroidSharedNetworkDaoUserInfoResponse:(CoTouchlabDroidconandroidSharedNetworkDaoUserInfoResponse *)response {
  return DCTAbstractFindUserTask_saveUserResponseWithAndroidContentContext_withDCDUserAccount_withCoTouchlabDroidconandroidSharedNetworkDaoUserInfoResponse_(context, user, response);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[5].selector = @selector(saveUserResponseWithAndroidContentContext:withDCDUserAccount:withCoTouchlabDroidconandroidSharedNetworkDaoUserInfoResponse:);
  ...
  static const void *ptrTable[] = { "handleError", "LAndroidContentContext;LNSException;", "onComplete", "LAndroidContentContext;", "handleData", "LAndroidContentContext;LDCTAbstractFindUserTask_LoadFromDb;LDCTAbstractFindUserTask_LoadUserInfo;", "LJavaSqlSQLException;", "saveUserResponse", "LAndroidContentContext;LDCDUserAccount;LCoTouchlabDroidconandroidSharedNetworkDaoUserInfoResponse;", "LDCTAbstractFindUserTask_LoadFromDb;LDCTAbstractFindUserTask_LoadUserInfo;" };
  static const J2ObjcClassInfo _DCTAbstractFindUserTask = { "AbstractFindUserTask", "co.touchlab.droidconandroid.shared.tasks", ptrTable, methods, fields, 7, 0x401, 6, 2, -1, 9, -1, -1, -1 };
...
DCDUserAccount *DCTAbstractFindUserTask_saveUserResponseWithAndroidContentContext_withDCDUserAccount_withCoTouchlabDroidconandroidSharedNetworkDaoUserInfoResponse_(AndroidContentContext *context, DCDUserAccount *user, CoTouchlabDroidconandroidSharedNetworkDaoUserInfoResponse *response) {
  DCTAbstractFindUserTask_initialize();
  DCDUserAccount *newDbUser = create_DCDUserAccount_init();
  CoTouchlabDroidconandroidSharedUtilsUserDataHelper_userAccountToDbWithCoTouchlabDroidconandroidSharedNetworkDaoUserAccount_withDCDUserAccount_(((CoTouchlabDroidconandroidSharedNetworkDaoUserInfoResponse *) nil_chk(response))->user_, newDbUser);
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _DCTAbstractFindUserTask_LoadFromDb = { "LoadFromDb", "co.touchlab.droidconandroid.shared.tasks", ptrTable, methods, NULL, 7, 0x608, 1, 0, 2, -1, -1, -1, -1 };
...
+ (const J2ObjcClassInfo *)__metadata {
  static J2ObjcMethodInfo methods[] = {
    { NULL, "LCoTouchlabDroidconandroidSharedNetworkDaoUserInfoResponse;", 0x401, 0, -1, -1, -1, -1, -1 },
  };
  #pragma clang diagnostic push
  #pragma clang diagnostic ignored "-Wobjc-multiple-method-names"
  methods[0].selector = @selector(load__);
  ...
  static const J2ObjcClassInfo _DCTAbstractFindUserTask_LoadUserInfo = { "LoadUserInfo", "co.touchlab.droidconandroid.shared.tasks", ptrTable, methods, NULL, 7, 0x608, 1, 0, 1, -1, -1, -1, -1 };
