...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "findByServerName", "LNSString;", "valueOf", &JreEnum(DCDTrack, DEVELOPMENT), &JreEnum(DCDTrack, DESIGN), &JreEnum(DCDTrack, BUSINESS), &JreEnum(DCDTrack, DEVDESIGN), &JreEnum(DCDTrack, DESIGNLAB), "Ljava/lang/Enum<Lco/touchlab/droidconandroid/data/Track;>;" };
  static const J2ObjcClassInfo _DCDTrack = { "Track", "co.touchlab.droidconandroid.data", ptrTable, methods, fields, 7, 0x4011, 7, 9, -1, -1, -1, 8, -1 };
  return &_DCDTrack;
}
