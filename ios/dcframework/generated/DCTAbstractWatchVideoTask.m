...
- (void)runWithAndroidContentContext:(AndroidContentContext *)context {
  ...
  id<CoTouchlabDroidconandroidSharedNetworkWatchVideoRequest> watchVideoRequest = [((RetrofitRestAdapter *) nil_chk(restAdapter)) createWithIOSClass:CoTouchlabDroidconandroidSharedNetworkWatchVideoRequest_class_()];
  ...
  @try {
    RetrofitClientResponse *response = [self callVideoUrlWithCoTouchlabDroidconandroidSharedNetworkWatchVideoRequest:watchVideoRequest withNSString:email withNSString:uuid withLong:conventionId];
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  methods[3].selector = @selector(callVideoUrlWithCoTouchlabDroidconandroidSharedNetworkWatchVideoRequest:withNSString:withNSString:withLong:);
  ...
  static const void *ptrTable[] = { "onComplete", "LAndroidContentContext;", "run", "LNSException;", "callVideoUrl", "LCoTouchlabDroidconandroidSharedNetworkWatchVideoRequest;LNSString;LNSString;J", "handleError", "LAndroidContentContext;LNSException;" };
  static const J2ObjcClassInfo _DCTAbstractWatchVideoTask = { "AbstractWatchVideoTask", "co.touchlab.droidconandroid.shared.tasks", ptrTable, methods, fields, 7, 0x401, 5, 2, -1, -1, -1, -1, -1 };
