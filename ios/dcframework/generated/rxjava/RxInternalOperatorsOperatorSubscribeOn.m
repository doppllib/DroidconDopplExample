...
__attribute__((unused)) static void RxInternalOperatorsOperatorSubscribeOn_1_1_initWithRxInternalOperatorsOperatorSubscribeOn_1_withJavaLangThread_withRxSubscriber_(RxInternalOperatorsOperatorSubscribeOn_1_1 *self, RxInternalOperatorsOperatorSubscribeOn_1 *outer$, JavaLangThread *capture$0, RxSubscriber *param0);

__attribute__((unused)) static RxInternalOperatorsOperatorSubscribeOn_1_1 *new_RxInternalOperatorsOperatorSubscribeOn_1_1_initWithRxInternalOperatorsOperatorSubscribeOn_1_withJavaLangThread_withRxSubscriber_(RxInternalOperatorsOperatorSubscribeOn_1 *outer$, JavaLangThread *capture$0, RxSubscriber *param0) NS_RETURNS_RETAINED;

__attribute__((unused)) static RxInternalOperatorsOperatorSubscribeOn_1_1 *create_RxInternalOperatorsOperatorSubscribeOn_1_1_initWithRxInternalOperatorsOperatorSubscribeOn_1_withJavaLangThread_withRxSubscriber_(RxInternalOperatorsOperatorSubscribeOn_1 *outer$, JavaLangThread *capture$0, RxSubscriber *param0);
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _RxInternalOperatorsOperatorSubscribeOn_1 = { "", "rx.internal.operators", ptrTable, methods, fields, 7, 0x8008, 2, 3, 2, -1, 3, -1, -1 };
...
- (instancetype)initWithRxInternalOperatorsOperatorSubscribeOn_1:(RxInternalOperatorsOperatorSubscribeOn_1 *)outer$
                                              withJavaLangThread:(JavaLangThread *)capture$0
                                                withRxSubscriber:(RxSubscriber *)param0 {
  RxInternalOperatorsOperatorSubscribeOn_1_1_initWithRxInternalOperatorsOperatorSubscribeOn_1_withJavaLangThread_withRxSubscriber_(self, outer$, capture$0, param0);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const J2ObjcClassInfo _RxInternalOperatorsOperatorSubscribeOn_1_1 = { "", "rx.internal.operators", ptrTable, methods, fields, 7, 0x8008, 5, 2, 9, -1, 10, 11, -1 };
  return &_RxInternalOperatorsOperatorSubscribeOn_1_1;
}

@end

void RxInternalOperatorsOperatorSubscribeOn_1_1_initWithRxInternalOperatorsOperatorSubscribeOn_1_withJavaLangThread_withRxSubscriber_(RxInternalOperatorsOperatorSubscribeOn_1_1 *self, RxInternalOperatorsOperatorSubscribeOn_1 *outer$, JavaLangThread *capture$0, RxSubscriber *param0) {
  JreStrongAssign(&self->this$0_, outer$);
  JreStrongAssign(&self->val$t_, capture$0);
  RxSubscriber_initWithRxSubscriber_(self, param0);
}

RxInternalOperatorsOperatorSubscribeOn_1_1 *new_RxInternalOperatorsOperatorSubscribeOn_1_1_initWithRxInternalOperatorsOperatorSubscribeOn_1_withJavaLangThread_withRxSubscriber_(RxInternalOperatorsOperatorSubscribeOn_1 *outer$, JavaLangThread *capture$0, RxSubscriber *param0) {
  J2OBJC_NEW_IMPL(RxInternalOperatorsOperatorSubscribeOn_1_1, initWithRxInternalOperatorsOperatorSubscribeOn_1_withJavaLangThread_withRxSubscriber_, outer$, capture$0, param0)
}

RxInternalOperatorsOperatorSubscribeOn_1_1 *create_RxInternalOperatorsOperatorSubscribeOn_1_1_initWithRxInternalOperatorsOperatorSubscribeOn_1_withJavaLangThread_withRxSubscriber_(RxInternalOperatorsOperatorSubscribeOn_1 *outer$, JavaLangThread *capture$0, RxSubscriber *param0) {
  J2OBJC_CREATE_IMPL(RxInternalOperatorsOperatorSubscribeOn_1_1, initWithRxInternalOperatorsOperatorSubscribeOn_1_withJavaLangThread_withRxSubscriber_, outer$, capture$0, param0)
}
