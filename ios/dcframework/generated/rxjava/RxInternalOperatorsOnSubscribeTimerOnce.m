...
@interface RxInternalOperatorsOnSubscribeTimerOnce_1 : NSObject < RxFunctionsAction0 > {
 @public
...
J2OBJC_EMPTY_STATIC_INIT(RxInternalOperatorsOnSubscribeTimerOnce_1)

__attribute__((unused)) static void RxInternalOperatorsOnSubscribeTimerOnce_1_initWithRxSubscriber_(RxInternalOperatorsOnSubscribeTimerOnce_1 *self, RxSubscriber *capture$0);

__attribute__((unused)) static RxInternalOperatorsOnSubscribeTimerOnce_1 *new_RxInternalOperatorsOnSubscribeTimerOnce_1_initWithRxSubscriber_(RxSubscriber *capture$0) NS_RETURNS_RETAINED;

__attribute__((unused)) static RxInternalOperatorsOnSubscribeTimerOnce_1 *create_RxInternalOperatorsOnSubscribeTimerOnce_1_initWithRxSubscriber_(RxSubscriber *capture$0);
...
- (void)callWithId:(RxSubscriber *)child {
  ...
  [((RxScheduler_Worker *) nil_chk(worker)) scheduleWithRxFunctionsAction0:create_RxInternalOperatorsOnSubscribeTimerOnce_1_initWithRxSubscriber_(child) withLong:time_ withJavaUtilConcurrentTimeUnit:unit_];
}
...
@implementation RxInternalOperatorsOnSubscribeTimerOnce_1

- (instancetype)initWithRxSubscriber:(RxSubscriber *)capture$0 {
  RxInternalOperatorsOnSubscribeTimerOnce_1_initWithRxSubscriber_(self, capture$0);
  return self;
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "Lrx/Subscriber<-Ljava/lang/Long;>;", "LRxInternalOperatorsOnSubscribeTimerOnce;", "callWithId:" };
  static const J2ObjcClassInfo _RxInternalOperatorsOnSubscribeTimerOnce_1 = { "", "rx.internal.operators", ptrTable, methods, fields, 7, 0x8018, 2, 1, 1, -1, 2, -1, -1 };
  return &_RxInternalOperatorsOnSubscribeTimerOnce_1;
}

@end

void RxInternalOperatorsOnSubscribeTimerOnce_1_initWithRxSubscriber_(RxInternalOperatorsOnSubscribeTimerOnce_1 *self, RxSubscriber *capture$0) {
  JreStrongAssign(&self->val$child_, capture$0);
  NSObject_init(self);
}

RxInternalOperatorsOnSubscribeTimerOnce_1 *new_RxInternalOperatorsOnSubscribeTimerOnce_1_initWithRxSubscriber_(RxSubscriber *capture$0) {
  J2OBJC_NEW_IMPL(RxInternalOperatorsOnSubscribeTimerOnce_1, initWithRxSubscriber_, capture$0)
}

RxInternalOperatorsOnSubscribeTimerOnce_1 *create_RxInternalOperatorsOnSubscribeTimerOnce_1_initWithRxSubscriber_(RxSubscriber *capture$0) {
  J2OBJC_CREATE_IMPL(RxInternalOperatorsOnSubscribeTimerOnce_1, initWithRxSubscriber_, capture$0)
}
