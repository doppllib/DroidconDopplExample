...
//  source: /Users/kgalligan/devel-doppl/DroidconDopplExample/lib/src/main/java/co/touchlab/droidconandroid/data/DatabaseHelper.java
//
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LAndroidContentContext;", "getInstance", "onCreate", "LAndroidDatabaseSqliteSQLiteDatabase;", "onUpgrade", "LAndroidDatabaseSqliteSQLiteDatabase;II", "onOpen", "()Lco/touchlab/squeaky/dao/Dao<Lco/touchlab/droidconandroid/data/Venue;>;", "()Lco/touchlab/squeaky/dao/Dao<Lco/touchlab/droidconandroid/data/Event;>;", "()Lco/touchlab/squeaky/dao/Dao<Lco/touchlab/droidconandroid/data/UserAccount;>;", "()Lco/touchlab/squeaky/dao/Dao<Lco/touchlab/droidconandroid/data/EventSpeaker;>;", "()Lco/touchlab/squeaky/dao/Dao<Lco/touchlab/droidconandroid/data/Block;>;", "deleteEventsNotIn", "LJavaUtilSet;", "LJavaSqlSQLException;", "(Ljava/util/Set<Ljava/lang/Long;>;)V", "performTransactionOrThrowRuntime", "LJavaUtilConcurrentCallable;", "(Ljava/util/concurrent/Callable<Ljava/lang/Void;>;)V", &DCDDatabaseHelper_DATABASE_FILE_NAME, &DCDDatabaseHelper_instance };
  static const J2ObjcClassInfo _DCDDatabaseHelper = { "DatabaseHelper", "co.touchlab.droidconandroid.data", ptrTable, methods, fields, 7, 0x1, 12, 4, -1, -1, -1, -1, -1 };
...
void DCDDatabaseHelper_initWithAndroidContentContext_(DCDDatabaseHelper *self, AndroidContentContext *context) {
  ...
  JreStrongAssignAndConsume(&self->tableClasses_, [IOSObjectArray newArrayWithObjects:(id[]){ DCDVenue_class_(), DCDEvent_class_(), DCDBlock_class_(), DCDUserAccount_class_(), CoTouchlabDroidconandroidDataStaffEventAttendee_class_(), DCDEventSpeaker_class_() } count:6 type:IOSClass_class_()]);
}
