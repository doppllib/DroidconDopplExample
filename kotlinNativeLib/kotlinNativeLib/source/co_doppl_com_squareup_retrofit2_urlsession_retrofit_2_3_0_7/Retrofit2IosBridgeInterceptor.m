...
@interface Retrofit2IosBridgeInterceptor () {
 @public
...
J2OBJC_FIELD_SETTER(Retrofit2IosBridgeInterceptor, cookieJar_, id<Okhttp3CookieJar>)

__attribute__((unused)) static NSString *Retrofit2IosBridgeInterceptor_cookieHeaderWithJavaUtilList_(Retrofit2IosBridgeInterceptor *self, id<JavaUtilList> cookies);

@implementation Retrofit2IosBridgeInterceptor

- (instancetype)initWithOkhttp3CookieJar:(id<Okhttp3CookieJar>)cookieJar {
  Retrofit2IosBridgeInterceptor_initWithOkhttp3CookieJar_(self, cookieJar);
  return self;
}

- (Okhttp3Response *)interceptWithRetrofit2IosInterceptor_Chain:(id<Retrofit2IosInterceptor_Chain>)chain {
  Okhttp3Request *userRequest = [((id<Retrofit2IosInterceptor_Chain>) nil_chk(chain)) request];
  ...
  if (![((id<JavaUtilList>) nil_chk(cookies)) isEmpty]) {
    [((Okhttp3Request_Builder *) nil_chk(requestBuilder)) headerWithNSString:@"Cookie" withNSString:Retrofit2IosBridgeInterceptor_cookieHeaderWithJavaUtilList_(self, cookies)];
  }
...
- (NSString *)cookieHeaderWithJavaUtilList:(id<JavaUtilList>)cookies {
  return Retrofit2IosBridgeInterceptor_cookieHeaderWithJavaUtilList_(self, cookies);
}
...
+ (const J2ObjcClassInfo *)__metadata {
  ...
  static const void *ptrTable[] = { "LOkhttp3CookieJar;", "intercept", "LRetrofit2IosInterceptor_Chain;", "LJavaIoIOException;", "cookieHeader", "LJavaUtilList;", "(Ljava/util/List<Lokhttp3/Cookie;>;)Ljava/lang/String;" };
  static const J2ObjcClassInfo _Retrofit2IosBridgeInterceptor = { "BridgeInterceptor", "retrofit2.ios", ptrTable, methods, fields, 7, 0x11, 3, 1, -1, -1, -1, -1, -1 };
  return &_Retrofit2IosBridgeInterceptor;
}

@end

void Retrofit2IosBridgeInterceptor_initWithOkhttp3CookieJar_(Retrofit2IosBridgeInterceptor *self, id<Okhttp3CookieJar> cookieJar) {
  NSObject_init(self);
  JreStrongAssign(&self->cookieJar_, cookieJar);
}

Retrofit2IosBridgeInterceptor *new_Retrofit2IosBridgeInterceptor_initWithOkhttp3CookieJar_(id<Okhttp3CookieJar> cookieJar) {
  J2OBJC_NEW_IMPL(Retrofit2IosBridgeInterceptor, initWithOkhttp3CookieJar_, cookieJar)
}

Retrofit2IosBridgeInterceptor *create_Retrofit2IosBridgeInterceptor_initWithOkhttp3CookieJar_(id<Okhttp3CookieJar> cookieJar) {
  J2OBJC_CREATE_IMPL(Retrofit2IosBridgeInterceptor, initWithOkhttp3CookieJar_, cookieJar)
}

NSString *Retrofit2IosBridgeInterceptor_cookieHeaderWithJavaUtilList_(Retrofit2IosBridgeInterceptor *self, id<JavaUtilList> cookies) {
...
J2OBJC_CLASS_TYPE_LITERAL_SOURCE(Retrofit2IosBridgeInterceptor)
