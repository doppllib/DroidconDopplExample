...
//#include <utils/Log.h>
#include <stdlib.h>
#include "UtilsString8.h"
#include "UtilsString16.h"
#include <sys/mman.h>
...
extern "C" JNIEXPORT jlong JNICALL Java_android_database_sqlite_SQLiteConnection_nativeOpen(JNIEnv* env, jclass clazz, jstring pathStr, jint openFlags,
                                                                                 jstring labelStr, jboolean enableTrace, jboolean enableProfile)
{
    return nativeOpen(env, clazz, pathStr, openFlags,
...
extern "C" JNIEXPORT void JNICALL Java_android_database_sqlite_SQLiteConnection_nativeClose(JNIEnv* env, jclass clazz, jlong connectionPtr)
{
    nativeClose(env, clazz, connectionPtr);
}

// Called each time a custom function is evaluated.
static void sqliteCustomFunctionCallback(sqlite3_context *context,
        int argc, sqlite3_value **argv) {
    JNIEnv* env = globalEnv;//AndroidRuntime::getJNIEnv();
...
extern "C" JNIEXPORT void JNICALL Java_android_database_sqlite_SQLiteConnection_nativeRegisterCustomFunction(JNIEnv* env, jclass clazz, jlong connectionPtr,
                                                                                 jobject functionObj)
{
    nativeRegisterCustomFunction(env, clazz, connectionPtr,
            functionObj);
}
...
extern "C" JNIEXPORT void JNICALL Java_android_database_sqlite_SQLiteConnection_nativeRegisterLocalizedCollators(JNIEnv* env, jclass clazz, jlong connectionPtr,
                                                                                 jstring localeStr)
{
    nativeRegisterLocalizedCollators(env, clazz, connectionPtr,
            localeStr);
}
...
extern "C" JNIEXPORT jlong JNICALL Java_android_database_sqlite_SQLiteConnection_nativePrepareStatement(JNIEnv* env, jclass clazz, jlong connectionPtr,
                                                                                  jstring sqlString)
{
    return nativePrepareStatement(env, clazz, connectionPtr,
                   sqlString);
}
...
extern "C" JNIEXPORT void JNICALL Java_android_database_sqlite_SQLiteConnection_nativeFinalizeStatement(JNIEnv* env, jclass clazz, jlong connectionPtr,
                                                                                 jlong statementPtr)
{
    nativeFinalizeStatement(env, clazz, connectionPtr,
            statementPtr);
}
...
extern "C" JNIEXPORT jint JNICALL Java_android_database_sqlite_SQLiteConnection_nativeGetParameterCount(JNIEnv* env, jclass clazz, jlong connectionPtr,
                                                                                 jlong statementPtr)
{
    return nativeGetParameterCount(env, clazz, connectionPtr,
                   statementPtr);
}
...
extern "C" JNIEXPORT jboolean JNICALL Java_android_database_sqlite_SQLiteConnection_nativeIsReadOnly(JNIEnv* env, jclass clazz, jlong connectionPtr,
                                                                                 jlong statementPtr)
{
    return nativeIsReadOnly(env, clazz, connectionPtr,
                   statementPtr);
}
...
extern "C" JNIEXPORT jint JNICALL Java_android_database_sqlite_SQLiteConnection_nativeGetColumnCount(JNIEnv* env, jclass clazz, jlong connectionPtr,
                                                                                 jlong statementPtr)
{
    return nativeGetColumnCount(env, clazz, connectionPtr,
                   statementPtr);
}
...
extern "C" JNIEXPORT jstring JNICALL Java_android_database_sqlite_SQLiteConnection_nativeGetColumnName(JNIEnv* env, jclass clazz, jlong connectionPtr,
                                                                                 jlong statementPtr, jint index)
{
    return nativeGetColumnName(env, clazz, connectionPtr,
                   statementPtr, index);
}
...
extern "C" JNIEXPORT void JNICALL Java_android_database_sqlite_SQLiteConnection_nativeBindNull(JNIEnv* env, jclass clazz, jlong connectionPtr,
                                                                                 jlong statementPtr, jint index)
{
    nativeBindNull(env, clazz, connectionPtr,
            statementPtr, index);
}
...
extern "C" JNIEXPORT void JNICALL Java_android_database_sqlite_SQLiteConnection_nativeBindLong(JNIEnv* env, jclass clazz, jlong connectionPtr,
                                                                                 jlong statementPtr, jint index, jlong value)
{
    nativeBindLong(env, clazz, connectionPtr,
            statementPtr, index, value);
}
...
extern "C" JNIEXPORT void JNICALL Java_android_database_sqlite_SQLiteConnection_nativeBindDouble(JNIEnv* env, jclass clazz, jlong connectionPtr,
                                                                                 jlong statementPtr, jint index, jdouble value)
{
    nativeBindDouble(env, clazz, connectionPtr,
            statementPtr, index, value);
}
...
extern "C" JNIEXPORT void JNICALL Java_android_database_sqlite_SQLiteConnection_nativeBindString(JNIEnv* env, jclass clazz, jlong connectionPtr,
                                                                                 jlong statementPtr, jint index, jstring valueString)
{
    nativeBindString(env, clazz, connectionPtr,
            statementPtr, index, valueString);
}
...
extern "C" JNIEXPORT void JNICALL Java_android_database_sqlite_SQLiteConnection_nativeBindBlob(JNIEnv* env, jclass clazz, jlong connectionPtr,
                                                                                 jlong statementPtr, jint index, jbyteArray valueArray)
{
    nativeBindBlob(env, clazz, connectionPtr,
            statementPtr, index, valueArray);
}
...
extern "C" JNIEXPORT void JNICALL Java_android_database_sqlite_SQLiteConnection_nativeResetStatementAndClearBindings(JNIEnv* env, jclass clazz, jlong connectionPtr,
                                                                                 jlong statementPtr)
{
    nativeResetStatementAndClearBindings(env, clazz, connectionPtr,
            statementPtr);
}
...
extern "C" JNIEXPORT void JNICALL Java_android_database_sqlite_SQLiteConnection_nativeExecute(JNIEnv* env, jclass clazz, jlong connectionPtr,
                                                                                 jlong statementPtr)
{
    nativeExecute(env, clazz, connectionPtr,
            statementPtr);
}
...
extern "C" JNIEXPORT jint JNICALL Java_android_database_sqlite_SQLiteConnection_nativeExecuteForChangedRowCount(JNIEnv* env, jclass clazz,
                                                                                 jlong connectionPtr, jlong statementPtr)
{
    return nativeExecuteForChangedRowCount(env, clazz,
...
extern "C" JNIEXPORT jlong JNICALL Java_android_database_sqlite_SQLiteConnection_nativeExecuteForLastInsertedRowId(JNIEnv* env, jclass clazz,
                                                                                 jlong connectionPtr, jlong statementPtr)
{
    return nativeExecuteForLastInsertedRowId(env, clazz,
                   connectionPtr, statementPtr);
}
...
extern "C" JNIEXPORT jlong JNICALL Java_android_database_sqlite_SQLiteConnection_nativeExecuteForLong(JNIEnv* env, jclass clazz,
                                                                                  jlong connectionPtr, jlong statementPtr)
{
    return nativeExecuteForLong(env, clazz,
                   connectionPtr, statementPtr);
}
...
extern "C" JNIEXPORT jstring JNICALL Java_android_database_sqlite_SQLiteConnection_nativeExecuteForString(JNIEnv* env, jclass clazz,
                                                                                 jlong connectionPtr, jlong statementPtr)
{
    return nativeExecuteForString(env, clazz,
                   connectionPtr, statementPtr);
}
...
extern "C" JNIEXPORT jlong JNICALL Java_android_database_sqlite_SQLiteConnection_nativeExecuteForCursorWindow(JNIEnv* env, jclass clazz,
                                                                                  jlong connectionPtr, jlong statementPtr, jlong windowPtr,
                                                                                  jint startPos, jint requiredPos, jboolean countAllRows)
{
    return nativeExecuteForCursorWindow(env, clazz,
...
extern "C" JNIEXPORT jint JNICALL Java_android_database_sqlite_SQLiteConnection_nativeGetDbLookaside(JNIEnv* env, jobject clazz, jlong connectionPtr)
{
    return nativeGetDbLookaside(env, clazz, connectionPtr);
}
...
extern "C" JNIEXPORT void JNICALL Java_android_database_sqlite_SQLiteConnection_nativeCancel(JNIEnv* env, jobject clazz, jlong connectionPtr)
{
    nativeCancel(env, clazz, connectionPtr);
}
...
extern "C" JNIEXPORT void JNICALL Java_android_database_sqlite_SQLiteConnection_nativeResetCancel(JNIEnv* env, jobject clazz, jlong connectionPtr,
                                                                                 jboolean cancelable)
{
    nativeResetCancel(env, clazz, connectionPtr,
            cancelable) ;
}
