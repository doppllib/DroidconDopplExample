...
extern "C" JNIEXPORT jlong JNICALL Java_android_database_CursorWindow_nativeCreate(JNIEnv* env, jclass clazz, jstring nameObj, jint cursorWindowSize)
{
    return nativeCreate(env, clazz, nameObj, cursorWindowSize);
}
...
extern "C" JNIEXPORT void JNICALL Java_android_database_CursorWindow_nativeDispose(JNIEnv* env, jclass clazz, jlong windowPtr)
{
    nativeDispose(env, clazz, windowPtr);
}
...
extern "C" JNIEXPORT jstring JNICALL Java_android_database_CursorWindow_nativeGetName(JNIEnv* env, jclass clazz, jlong windowPtr)
{
    return nativeGetName(env, clazz, windowPtr);
}
...
extern "C" JNIEXPORT void JNICALL Java_android_database_CursorWindow_nativeClear(JNIEnv * env, jclass clazz, jlong windowPtr)
{
 nativeClear(env, clazz, windowPtr);
}
...
extern "C" JNIEXPORT jint JNICALL Java_android_database_CursorWindow_nativeGetNumRows(JNIEnv* env, jclass clazz, jlong windowPtr)
{
return nativeGetNumRows(env, clazz, windowPtr);
}
...
extern "C" JNIEXPORT jboolean JNICALL Java_android_database_CursorWindow_nativeSetNumColumns(JNIEnv* env, jclass clazz, jlong windowPtr, jint columnNum)
{
    return nativeSetNumColumns(env, clazz, windowPtr,
                   columnNum);
}
...
extern "C" JNIEXPORT jboolean JNICALL Java_android_database_CursorWindow_nativeAllocRow(JNIEnv* env, jclass clazz, jlong windowPtr)
{
    return nativeAllocRow(env, clazz, windowPtr);
}
...
extern "C" JNIEXPORT void JNICALL Java_android_database_CursorWindow_nativeFreeLastRow(JNIEnv* env, jclass clazz, jlong windowPtr)
{
    nativeFreeLastRow(env, clazz, windowPtr);
}
...
extern "C" JNIEXPORT jint JNICALL Java_android_database_CursorWindow_nativeGetType(JNIEnv* env, jclass clazz, jlong windowPtr, jint row, jint column)
{
    return nativeGetType(env, clazz, windowPtr,
                   row, column);
}
...
extern "C" JNIEXPORT jbyteArray JNICALL Java_android_database_CursorWindow_nativeGetBlob(JNIEnv* env, jclass clazz, jlong windowPtr,
                                                                              jint row, jint column)
{
return nativeGetBlob(env, clazz, windowPtr,
        row, column);
}
...
extern "C" JNIEXPORT jstring JNICALL Java_android_database_CursorWindow_nativeGetString(JNIEnv* env, jclass clazz, jlong windowPtr,
                                                                              jint row, jint column)
{
    return nativeGetString(env, clazz, windowPtr,
                   row, column);
}
...
extern "C" JNIEXPORT void JNICALL Java_android_database_CursorWindow_nativeCopyStringToBuffer(JNIEnv* env, jclass clazz, jlong windowPtr,
                                                                              jint row, jint column, jobject bufferObj)
{
...
extern "C" JNIEXPORT jlong JNICALL Java_android_database_CursorWindow_nativeGetLong(JNIEnv* env, jclass clazz, jlong windowPtr,
                                                                              jint row, jint column)
{
    return nativeGetLong(env, clazz, windowPtr,
                   row, column);
}
...
extern "C" JNIEXPORT jdouble JNICALL Java_android_database_CursorWindow_nativeGetDouble(JNIEnv* env, jclass clazz, jlong windowPtr,
                                                                              jint row, jint column)
{
    return nativeGetDouble(env, clazz, windowPtr,
                   row, column);
}
...
extern "C" JNIEXPORT jboolean JNICALL Java_android_database_CursorWindow_nativePutBlob(JNIEnv* env, jclass clazz, jlong windowPtr,
                                                                              jbyteArray valueObj, jint row, jint column)
{
    return nativePutBlob(env, clazz, windowPtr,
                   valueObj, row, column);
}
...
extern "C" JNIEXPORT jboolean JNICALL Java_android_database_CursorWindow_nativePutString(JNIEnv* env, jclass clazz, jlong windowPtr,
                                                                              jstring valueObj, jint row, jint column)
{
return nativePutString(env, clazz, windowPtr,
               valueObj, row, column);
}
...
extern "C" JNIEXPORT jboolean JNICALL Java_android_database_CursorWindow_nativePutLong(JNIEnv* env, jclass clazz, jlong windowPtr,
                                                                              jlong value, jint row, jint column)
{
    return nativePutLong(env, clazz, windowPtr,
                   value, row, column);
}
...
extern "C" JNIEXPORT jboolean JNICALL Java_android_database_CursorWindow_nativePutDouble(JNIEnv* env, jclass clazz, jlong windowPtr,
                                                                              jdouble value, jint row, jint column)
{
    return nativePutDouble(env, clazz, windowPtr,
                   value, row, column);
}
...
extern "C" JNIEXPORT jboolean JNICALL Java_android_database_CursorWindow_nativePutNull(JNIEnv* env, jclass clazz, jlong windowPtr,
                                                                              jint row, jint column)
{
    return nativePutNull(env, clazz, windowPtr,
                   row, column);
}
