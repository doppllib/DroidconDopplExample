...
extern "C" JNIEXPORT jint JNICALL Java_android_database_sqlite_SQLiteGlobal_nativeReleaseMemory(JNIEnv* env, jclass clazz)
{
    return nativeReleaseMemory(env, clazz);
}

extern "C" JNIEXPORT void JNICALL Java_android_database_sqlite_SQLiteGlobal_initStatics(JNIEnv* env, jclass clazz)
{
    initialize_string8();
    initialize_string16();
}
