...
+ (jboolean)DEFAULT_JSON_NON_EXECUTABLE {
  return ComGoogleGsonGson_DEFAULT_JSON_NON_EXECUTABLE;
}

+ (jboolean)DEFAULT_LENIENT {
  return ComGoogleGsonGson_DEFAULT_LENIENT;
}

+ (jboolean)DEFAULT_PRETTY_PRINT {
  return ComGoogleGsonGson_DEFAULT_PRETTY_PRINT;
}

+ (jboolean)DEFAULT_ESCAPE_HTML {
  return ComGoogleGsonGson_DEFAULT_ESCAPE_HTML;
}

+ (jboolean)DEFAULT_SERIALIZE_NULLS {
  return ComGoogleGsonGson_DEFAULT_SERIALIZE_NULLS;
}

+ (jboolean)DEFAULT_COMPLEX_MAP_KEYS {
  return ComGoogleGsonGson_DEFAULT_COMPLEX_MAP_KEYS;
}

+ (jboolean)DEFAULT_SPECIALIZE_FLOAT_VALUES {
  return ComGoogleGsonGson_DEFAULT_SPECIALIZE_FLOAT_VALUES;
}
