...
+ (ComGoogleGsonInternalJsonReaderInternalAccess *)INSTANCE {
  return ComGoogleGsonInternalJsonReaderInternalAccess_INSTANCE;
}

+ (void)setINSTANCE:(ComGoogleGsonInternalJsonReaderInternalAccess *)value {
  JreStrongAssign(&ComGoogleGsonInternalJsonReaderInternalAccess_INSTANCE, value);
}
