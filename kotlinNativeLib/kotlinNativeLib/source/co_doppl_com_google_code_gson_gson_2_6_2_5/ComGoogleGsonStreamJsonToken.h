...
+ (ComGoogleGsonStreamJsonToken * __nonnull)BEGIN_ARRAY;

+ (ComGoogleGsonStreamJsonToken * __nonnull)END_ARRAY;

+ (ComGoogleGsonStreamJsonToken * __nonnull)BEGIN_OBJECT;

+ (ComGoogleGsonStreamJsonToken * __nonnull)END_OBJECT;

+ (ComGoogleGsonStreamJsonToken * __nonnull)NAME;

+ (ComGoogleGsonStreamJsonToken * __nonnull)STRING;

+ (ComGoogleGsonStreamJsonToken * __nonnull)NUMBER;

+ (ComGoogleGsonStreamJsonToken * __nonnull)BOOLEAN;

+ (ComGoogleGsonStreamJsonToken * __nonnull)NULL_;

+ (ComGoogleGsonStreamJsonToken * __nonnull)END_DOCUMENT;
