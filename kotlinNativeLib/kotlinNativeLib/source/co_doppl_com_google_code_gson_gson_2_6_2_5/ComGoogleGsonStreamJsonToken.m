...
+ (ComGoogleGsonStreamJsonToken *)BEGIN_ARRAY {
  return JreEnum(ComGoogleGsonStreamJsonToken, BEGIN_ARRAY);
}

+ (ComGoogleGsonStreamJsonToken *)END_ARRAY {
  return JreEnum(ComGoogleGsonStreamJsonToken, END_ARRAY);
}

+ (ComGoogleGsonStreamJsonToken *)BEGIN_OBJECT {
  return JreEnum(ComGoogleGsonStreamJsonToken, BEGIN_OBJECT);
}

+ (ComGoogleGsonStreamJsonToken *)END_OBJECT {
  return JreEnum(ComGoogleGsonStreamJsonToken, END_OBJECT);
}

+ (ComGoogleGsonStreamJsonToken *)NAME {
  return JreEnum(ComGoogleGsonStreamJsonToken, NAME);
}

+ (ComGoogleGsonStreamJsonToken *)STRING {
  return JreEnum(ComGoogleGsonStreamJsonToken, STRING);
}

+ (ComGoogleGsonStreamJsonToken *)NUMBER {
  return JreEnum(ComGoogleGsonStreamJsonToken, NUMBER);
}

+ (ComGoogleGsonStreamJsonToken *)BOOLEAN {
  return JreEnum(ComGoogleGsonStreamJsonToken, BOOLEAN);
}

+ (ComGoogleGsonStreamJsonToken *)NULL_ {
  return JreEnum(ComGoogleGsonStreamJsonToken, NULL);
}

+ (ComGoogleGsonStreamJsonToken *)END_DOCUMENT {
  return JreEnum(ComGoogleGsonStreamJsonToken, END_DOCUMENT);
}
...
- (ComGoogleGsonStreamJsonToken_Enum)toNSEnum {
  return (ComGoogleGsonStreamJsonToken_Enum)[self ordinal];
}
