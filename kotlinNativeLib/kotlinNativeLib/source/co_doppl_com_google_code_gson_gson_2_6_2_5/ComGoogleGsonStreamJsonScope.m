...
+ (jint)EMPTY_ARRAY {
  return ComGoogleGsonStreamJsonScope_EMPTY_ARRAY;
}

+ (jint)NONEMPTY_ARRAY {
  return ComGoogleGsonStreamJsonScope_NONEMPTY_ARRAY;
}

+ (jint)EMPTY_OBJECT {
  return ComGoogleGsonStreamJsonScope_EMPTY_OBJECT;
}

+ (jint)DANGLING_NAME {
  return ComGoogleGsonStreamJsonScope_DANGLING_NAME;
}

+ (jint)NONEMPTY_OBJECT {
  return ComGoogleGsonStreamJsonScope_NONEMPTY_OBJECT;
}

+ (jint)EMPTY_DOCUMENT {
  return ComGoogleGsonStreamJsonScope_EMPTY_DOCUMENT;
}

+ (jint)NONEMPTY_DOCUMENT {
  return ComGoogleGsonStreamJsonScope_NONEMPTY_DOCUMENT;
}

+ (jint)CLOSED {
  return ComGoogleGsonStreamJsonScope_CLOSED;
}
