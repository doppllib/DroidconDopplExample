...
+ (ComGoogleGsonFieldNamingPolicy * __nonnull)IDENTITY;

+ (ComGoogleGsonFieldNamingPolicy * __nonnull)UPPER_CAMEL_CASE;

+ (ComGoogleGsonFieldNamingPolicy * __nonnull)UPPER_CAMEL_CASE_WITH_SPACES;

+ (ComGoogleGsonFieldNamingPolicy * __nonnull)LOWER_CASE_WITH_UNDERSCORES;

+ (ComGoogleGsonFieldNamingPolicy * __nonnull)LOWER_CASE_WITH_DASHES;
