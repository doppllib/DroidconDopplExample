...
+ (ComGoogleGsonLongSerializationPolicy *)DEFAULT {
  return JreEnum(ComGoogleGsonLongSerializationPolicy, DEFAULT);
}

+ (ComGoogleGsonLongSerializationPolicy *)STRING {
  return JreEnum(ComGoogleGsonLongSerializationPolicy, STRING);
}
...
- (ComGoogleGsonLongSerializationPolicy_Enum)toNSEnum {
  return (ComGoogleGsonLongSerializationPolicy_Enum)[self ordinal];
}
